...
// the browser is a CanvasWithTextPaint (folio-go/internal/wasm/engine.go's three seams),
...
// recomputed by folio-go/internal/wasm/engine.go, so the paint must be derivable from
