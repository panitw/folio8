...
// folio8's ParseTemplate/LoadTemplate (folio-go/folio8.go) call this.
...
//
// THE SECOND DOOR IS DEFERRED PAST `folio-go/v1.0.0`, AND NO MIGRATION IS OWED.
...
// `internal/fontset/licencesignature.go` after `folio-go/v1.0.0` is cut, or
