# Arimo-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Arimo**, added by
...
the family **`Arimo Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `Arimo-4a6255f269916ae7ad3fc2706b0935e7621396b8/fonts/ttf/Arimo-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `3d855617e6d0f8c103cc20e527239db721e9168847490b35688f53650ea23566` (8,733,218 bytes) |
| **sha256 of the SOURCE (upstream) file** | `ffdf690e4357a392e4edcc3df0b3adb0302920f75e54f2e6eec355afbe7edcba` |
...
| item | value |
|---|---|
| **Shipped file** | `Arimo-Italic.ttf` |
| **sha256 of the SHIPPED file** | `ffdf690e4357a392e4edcc3df0b3adb0302920f75e54f2e6eec355afbe7edcba` |
| Size | 502,332 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Arimo` / `Italic` |
