# NotoSerif-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Noto Serif**, added by
...
the family **`Noto Serif Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `NotoSerif/unhinted/ttf/NotoSerif-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `0e9a43c8a4b94ac76f55069ed1d7385bbcaf6b99527a94deb5619e032b7e76c1` (70,637,713 bytes) |
| **sha256 of the SOURCE (upstream) file** | `c4b3c971741ecdb40f5a443bce754e8fe91efe761b6ea10c92be7c3597cdadc4` |
...
| item | value |
|---|---|
| **Shipped file** | `NotoSerif-Italic.ttf` |
| **sha256 of the SHIPPED file** | `c4b3c971741ecdb40f5a443bce754e8fe91efe761b6ea10c92be7c3597cdadc4` |
| Size | 513,428 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Noto Serif` / `Italic` |
