# SourceCodePro-BoldIt.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Source Code Pro**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../sourcecodepro/`, and **both come from
...
the family **`Source Code Pro Bold Italic`** into `src/generated/runtime-fonts.css`.
...
`OS/2.fsSelection` 0x0021, `head.macStyle` 0x3,
`post.italicAngle` -11, **no** `fvar`/`gvar` and **no** `CFF`/`CFF2` —
...
| Path inside the archive | `TTF/SourceCodePro-BoldIt.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `0c85bac90d15c040b82939aa92bc8404420fccc02e37bbcb9c93a7f21abb52c6` (1,294,648 bytes) |
| **sha256 of the SOURCE (upstream) file** | `1b49d9304012bf8db9e5dd4104183d5c122c445d0570a2259125f71977595b90` |
...
| item | value |
|---|---|
| **Shipped file** | `SourceCodePro-BoldIt.ttf` |
| **sha256 of the SHIPPED file** | `1b49d9304012bf8db9e5dd4104183d5c122c445d0570a2259125f71977595b90` |
| Size | 169,140 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Source Code Pro` / `Bold Italic` |
...
family's Regular, copied from `../sourcecodepro/LICENSE-OFL.md`.
Its sha256 is `0b2c3168605cb4f3ba54cf3cf2003f67ff894c66484c75702007f23eda92c353` (4,473 bytes).
