# Inter-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Inter**, added by
...
the family **`Inter Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `extras/ttf/Inter-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `9883fdd4a49d4fb66bd8177ba6625ef9a64aa45899767dde3d36aa425756b11e` (33,707,794 bytes) |
| **sha256 of the SOURCE (upstream) file** | `bbc051dd204b5019a1aa0bc0ae2aa8a05ab13e7a3f979fa357631dc7feb6833a` |
...
| item | value |
|---|---|
| **Shipped file** | `Inter-Italic.ttf` |
| **sha256 of the SHIPPED file** | `bbc051dd204b5019a1aa0bc0ae2aa8a05ab13e7a3f979fa357631dc7feb6833a` |
| Size | 417,388 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Inter` / `Italic` |
