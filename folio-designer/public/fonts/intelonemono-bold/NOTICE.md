# IntelOneMono-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Intel One Mono**, added by
...
the family **`Intel One Mono Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/IntelOneMono-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `54863552d25dcb9c3f5360b296fc980d6e1fbfd02e0d214224e8b78f0a2bccf0` (505,443 bytes) |
| **sha256 of the SOURCE (upstream) file** | `511623927c22f8c5e70af85598e01eaed06bf9eb875aa77452ce0f379a52826a` |
...
| item | value |
|---|---|
| **Shipped file** | `IntelOneMono-Bold.ttf` |
| **sha256 of the SHIPPED file** | `511623927c22f8c5e70af85598e01eaed06bf9eb875aa77452ce0f379a52826a` |
| Size | 124,708 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Intel One Mono` / `Bold` |
