# Arimo-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Arimo**, added by
...
the family **`Arimo Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `Arimo-4a6255f269916ae7ad3fc2706b0935e7621396b8/fonts/ttf/Arimo-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `3d855617e6d0f8c103cc20e527239db721e9168847490b35688f53650ea23566` (8,733,218 bytes) |
| **sha256 of the SOURCE (upstream) file** | `d7a8b187cf8444d4cfee102e8eae9e3043682fd5106d5d33ed677fe268a0e2ba` |
...
| item | value |
|---|---|
| **Shipped file** | `Arimo-Bold.ttf` |
| **sha256 of the SHIPPED file** | `d7a8b187cf8444d4cfee102e8eae9e3043682fd5106d5d33ed677fe268a0e2ba` |
| Size | 485,872 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Arimo` / `Bold` |
