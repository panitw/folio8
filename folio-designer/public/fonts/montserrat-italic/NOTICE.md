# Montserrat-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Montserrat**, added by
...
the family **`Montserrat Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `Montserrat-9.000/fonts/ttf/Montserrat-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `991b3f971c65081c780fa15645a030bdf9e21ee8734b9f6010638b83bae1ff83` (30,979,460 bytes) |
| **sha256 of the SOURCE (upstream) file** | `ec464aa10de945b7280c4f8c01393dfea3e98ba6483809c205fe2899d7944cdc` |
...
| item | value |
|---|---|
| **Shipped file** | `Montserrat-Italic.ttf` |
| **sha256 of the SHIPPED file** | `ec464aa10de945b7280c4f8c01393dfea3e98ba6483809c205fe2899d7944cdc` |
| Size | 449,764 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Montserrat` / `Italic` |
