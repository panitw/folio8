# SourceSans3-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Source Sans 3**, added by
...
the family **`Source Sans 3 Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `TTF/SourceSans3-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `1b0dd1ec44b39f1dd98bbd153a1a3815f083639874ddee02c842bd601bad3d21` (2,478,353 bytes) |
| **sha256 of the SOURCE (upstream) file** | `9214b9d95e4231c609802815c2646c98174e2102d0d37f88978a7f8e71006e6a` |
...
| item | value |
|---|---|
| **Shipped file** | `SourceSans3-Bold.ttf` |
| **sha256 of the SHIPPED file** | `9214b9d95e4231c609802815c2646c98174e2102d0d37f88978a7f8e71006e6a` |
| Size | 428,176 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Source Sans 3` / `Bold` |
