# OpenSans-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Open Sans**, added by
...
the family **`Open Sans Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `opensans-bd7e37632246368c60fdcbd374dbf9bad11969b6/fonts/ttf/OpenSans-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `a1b16d859522daa826fb093d791ee252a1627274ef1b90f2773d670eb73a2a92` (30,976,885 bytes) |
| **sha256 of the SOURCE (upstream) file** | `27da758f4dcac9a65abe914c13b463b42982b9909bc65713424099f4810bd1e6` |
...
| item | value |
|---|---|
| **Shipped file** | `OpenSans-Bold.ttf` |
| **sha256 of the SHIPPED file** | `27da758f4dcac9a65abe914c13b463b42982b9909bc65713424099f4810bd1e6` |
| Size | 147,264 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Open Sans` / `Bold` |
