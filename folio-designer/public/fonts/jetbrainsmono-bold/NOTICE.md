# JetBrainsMono-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **JetBrains Mono**, added by
...
the family **`JetBrains Mono Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `fonts/ttf/JetBrainsMono-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `6f6376c6ed2960ea8a963cd7387ec9d76e3f629125bc33d1fdcd7eb7012f7bbf` (5,622,857 bytes) |
| **sha256 of the SOURCE (upstream) file** | `5590990c82e097397517f275f430af4546e1c45cff408bde4255dad142479dcb` |
...
| item | value |
|---|---|
| **Shipped file** | `JetBrainsMono-Bold.ttf` |
| **sha256 of the SHIPPED file** | `5590990c82e097397517f275f430af4546e1c45cff408bde4255dad142479dcb` |
| Size | 277,828 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `JetBrains Mono` / `Bold` |
