# Lora-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Lora**, added by
...
the family **`Lora Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/Lora-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `19061972d1124d258dffd41f3ad12ce2db513f9b31fb98ece7afe7b538e8647f` (2,443,935 bytes) |
| **sha256 of the SOURCE (upstream) file** | `32baf740eac1bf3f257904a6cf89e4e067ca1566b375bf22f743a26fc88b3791` |
...
| item | value |
|---|---|
| **Shipped file** | `Lora-Bold.ttf` |
| **sha256 of the SHIPPED file** | `32baf740eac1bf3f257904a6cf89e4e067ca1566b375bf22f743a26fc88b3791` |
| Size | 218,640 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Lora` / `Bold` |
