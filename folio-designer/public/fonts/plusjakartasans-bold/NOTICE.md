# PlusJakartaSans-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Plus Jakarta Sans**, added by
...
the family **`Plus Jakarta Sans Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `PlusJakartaSans-2.7.1/ttf/PlusJakartaSans-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `4bfc5cdf97d750423bb3d1d40ed8e529bc92288924d9c65e18ff486acefac66c` (1,018,646 bytes) |
| **sha256 of the SOURCE (upstream) file** | `14972f80fb151f32fb7129c6ad1893f6dd2a9d8bac30c40508c99e7f289b6682` |
...
| item | value |
|---|---|
| **Shipped file** | `PlusJakartaSans-Bold.ttf` |
| **sha256 of the SHIPPED file** | `14972f80fb151f32fb7129c6ad1893f6dd2a9d8bac30c40508c99e7f289b6682` |
| Size | 132,116 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Plus Jakarta Sans` / `Bold` |
