# InterDisplay-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Inter Display**, added by
...
the family **`Inter Display Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `extras/ttf/InterDisplay-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `9883fdd4a49d4fb66bd8177ba6625ef9a64aa45899767dde3d36aa425756b11e` (33,707,794 bytes) |
| **sha256 of the SOURCE (upstream) file** | `20cf47556669f80d12966d2f5eac5054b7486ce5d076feb744dbe24842e2593b` |
...
| item | value |
|---|---|
| **Shipped file** | `InterDisplay-Italic.ttf` |
| **sha256 of the SHIPPED file** | `20cf47556669f80d12966d2f5eac5054b7486ce5d076feb744dbe24842e2593b` |
| Size | 414,908 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Inter Display` / `Italic` |
