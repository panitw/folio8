# UbuntuSansMono-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Ubuntu Sans Mono**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../ubuntusansmono/`, and **both come from
...
the family **`Ubuntu Sans Mono Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `Ubuntu-Sans-Mono-fonts-v1.100/fonts/ttf/UbuntuSansMono-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `0e459ed18b552190971561b3e474d0c4583db40483debf9e951321c2a1c2dec8` (8,148,916 bytes) |
| **sha256 of the SOURCE (upstream) file** | `a43ee4648db4270651df50053dc2adffbc3f2b3d0f5ce6d67e3301e4830209da` |
...
| item | value |
|---|---|
| **Shipped file** | `UbuntuSansMono-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `a43ee4648db4270651df50053dc2adffbc3f2b3d0f5ce6d67e3301e4830209da` |
| Size | 218,100 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Ubuntu Sans Mono` / `Bold Italic` |
...
family's Regular, copied from `../ubuntusansmono/LICENSE-UFL.txt`.
