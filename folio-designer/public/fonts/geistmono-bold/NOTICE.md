# GeistMono-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Geist Mono**, added by
...
the family **`Geist Mono Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `geist-font/GeistMono/ttf/GeistMono-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `7fc800d2ac6b92844895196e5041aca55d814c15db70c44f79b3b83ab82b04e2` (8,207,303 bytes) |
| **sha256 of the SOURCE (upstream) file** | `ea1cabb4d152088721b5e0b1865bb43c75c1b2d468384a551e0958e53d4fa370` |
...
| item | value |
|---|---|
| **Shipped file** | `GeistMono-Bold.ttf` |
| **sha256 of the SHIPPED file** | `ea1cabb4d152088721b5e0b1865bb43c75c1b2d468384a551e0958e53d4fa370` |
| Size | 150,492 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Geist Mono` / `Bold` |
