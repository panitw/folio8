# Literata-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Literata**, added by
...
the family **`Literata Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `fonts/ttf/Literata-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `f7fb973cafb26cf785cbebaeaf51c18f87c15a3bcf4d82a7d4857564db5b056d` (17,546,949 bytes) |
| **sha256 of the SOURCE (upstream) file** | `b6af95b3b443cdbce964aa06741596987f2f5c3ede46a2bc846e5addd99d061f` |
...
| item | value |
|---|---|
| **Shipped file** | `Literata-Bold.ttf` |
| **sha256 of the SHIPPED file** | `b6af95b3b443cdbce964aa06741596987f2f5c3ede46a2bc846e5addd99d061f` |
| Size | 331,304 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Literata` / `Bold` |
