# Geist-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Geist**, added by
...
the family **`Geist Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `geist-font/Geist/ttf/Geist-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `7fc800d2ac6b92844895196e5041aca55d814c15db70c44f79b3b83ab82b04e2` (8,207,303 bytes) |
| **sha256 of the SOURCE (upstream) file** | `d4b95dddb27051775acefc49a6c25122d748400316b651e3cb85f0afd121a1f8` |
...
| item | value |
|---|---|
| **Shipped file** | `Geist-Italic.ttf` |
| **sha256 of the SHIPPED file** | `d4b95dddb27051775acefc49a6c25122d748400316b651e3cb85f0afd121a1f8` |
| Size | 128,284 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Geist` / `Italic` |
