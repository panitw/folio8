# Geist-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Geist**, added by
...
the family **`Geist Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `geist-font/Geist/ttf/Geist-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `7fc800d2ac6b92844895196e5041aca55d814c15db70c44f79b3b83ab82b04e2` (8,207,303 bytes) |
| **sha256 of the SOURCE (upstream) file** | `e866b423b755233cae8bce6a37519f6fe630be9772fa08fc3114bff15bc8580f` |
...
| item | value |
|---|---|
| **Shipped file** | `Geist-Bold.ttf` |
| **sha256 of the SHIPPED file** | `e866b423b755233cae8bce6a37519f6fe630be9772fa08fc3114bff15bc8580f` |
| Size | 128,824 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Geist` / `Bold` |
