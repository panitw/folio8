# IntelOneMono-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Intel One Mono**, added by
...
the family **`Intel One Mono Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/IntelOneMono-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `54863552d25dcb9c3f5360b296fc980d6e1fbfd02e0d214224e8b78f0a2bccf0` (505,443 bytes) |
| **sha256 of the SOURCE (upstream) file** | `88aa389ce50467cc189b1176bdde8a1d1f8bd8adea879b5eed595f46b8ead0e8` |
...
| item | value |
|---|---|
| **Shipped file** | `IntelOneMono-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `88aa389ce50467cc189b1176bdde8a1d1f8bd8adea879b5eed595f46b8ead0e8` |
| Size | 127,716 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Intel One Mono` / `Bold Italic` |
