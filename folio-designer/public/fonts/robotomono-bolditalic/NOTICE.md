# RobotoMono-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Roboto Mono**, added by
...
the family **`Roboto Mono Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `RobotoMono-3.001/fonts/ttf/RobotoMono-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `677d8513918572700531a3115f721a416557a5c701b150abc4d118a7177c8bdc` (4,516,663 bytes) |
| **sha256 of the SOURCE (upstream) file** | `a0f16567447311eaf42a35f6c50eb64b911694b42f1b01038e3b7e92c20f131d` |
...
| item | value |
|---|---|
| **Shipped file** | `RobotoMono-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `a0f16567447311eaf42a35f6c50eb64b911694b42f1b01038e3b7e92c20f131d` |
| Size | 135,992 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Roboto Mono` / `Bold Italic` |
