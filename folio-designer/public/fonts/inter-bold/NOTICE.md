# Inter-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Inter**, added by
...
the family **`Inter Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `extras/ttf/Inter-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `9883fdd4a49d4fb66bd8177ba6625ef9a64aa45899767dde3d36aa425756b11e` (33,707,794 bytes) |
| **sha256 of the SOURCE (upstream) file** | `288316099b1e0a47a4716d159098005eef7c0066921f34e3200393dbdb01947f` |
...
| item | value |
|---|---|
| **Shipped file** | `Inter-Bold.ttf` |
| **sha256 of the SHIPPED file** | `288316099b1e0a47a4716d159098005eef7c0066921f34e3200393dbdb01947f` |
| Size | 420,428 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Inter` / `Bold` |
