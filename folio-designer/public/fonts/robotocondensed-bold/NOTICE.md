# RobotoCondensed-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Roboto Condensed**, added by
...
the family **`Roboto Condensed Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `android/static/RobotoCondensed-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `1653dbe12f248da8fb0b9920db7b9496cd677ed3981154f6f15285c8bd4e334f` (29,162,959 bytes) |
| **sha256 of the SOURCE (upstream) file** | `a2929ecfdc87499679bc579da2e3cecead7fe0988607fb003afd9c07854a9594` |
...
| item | value |
|---|---|
| **Shipped file** | `RobotoCondensed-Bold.ttf` |
| **sha256 of the SHIPPED file** | `a2929ecfdc87499679bc579da2e3cecead7fe0988607fb003afd9c07854a9594` |
| Size | 357,024 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Roboto Condensed` / `Bold` |
