# CascadiaCode-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Cascadia Code**, added by
...
the family **`Cascadia Code Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/static/CascadiaCode-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `e67a68ee3386db63f48b9054bd196ea752bc6a4ebb4df35adce6733da50c8474` (150,454,761 bytes) |
| **sha256 of the SOURCE (upstream) file** | `1f0676937792fe550effeafb7f4622080c2a5d62715d1245d471258fa1a23b8c` |
...
| item | value |
|---|---|
| **Shipped file** | `CascadiaCode-Italic.ttf` |
| **sha256 of the SHIPPED file** | `1f0676937792fe550effeafb7f4622080c2a5d62715d1245d471258fa1a23b8c` |
| Size | 453,184 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Cascadia Code` / `Italic` |
