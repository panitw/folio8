# RobotoMono-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Roboto Mono**, added by
...
the family **`Roboto Mono Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `RobotoMono-3.001/fonts/ttf/RobotoMono-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `677d8513918572700531a3115f721a416557a5c701b150abc4d118a7177c8bdc` (4,516,663 bytes) |
| **sha256 of the SOURCE (upstream) file** | `3ecf35e5e87accc7578b605d1f5f0bc30d88b195d6807bec8a0c57f6aa95c4db` |
...
| item | value |
|---|---|
| **Shipped file** | `RobotoMono-Bold.ttf` |
| **sha256 of the SHIPPED file** | `3ecf35e5e87accc7578b605d1f5f0bc30d88b195d6807bec8a0c57f6aa95c4db` |
| Size | 126,680 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Roboto Mono` / `Bold` |
