# UbuntuSans-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Ubuntu Sans**, added by
...
the family **`Ubuntu Sans Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `UbuntuSans-fonts-1.006/ttf/UbuntuSans-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `20aa7af47beaa6d64327782f7bf60df375edeedbdee2fe407e0bf9721890fb83` (29,602,887 bytes) |
| **sha256 of the SOURCE (upstream) file** | `185c0fcde30b8b75c543793aeaa27927cc1a9970dac89b13e18acd1b26a3bbb7` |
...
| item | value |
|---|---|
| **Shipped file** | `UbuntuSans-Bold.ttf` |
| **sha256 of the SHIPPED file** | `185c0fcde30b8b75c543793aeaa27927cc1a9970dac89b13e18acd1b26a3bbb7` |
| Size | 486,612 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Ubuntu Sans` / `Bold` |
