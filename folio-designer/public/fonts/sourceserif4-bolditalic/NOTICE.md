# SourceSerif4Display-BoldIt.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Source Serif 4 Display**, added by
...
the family **`Source Serif 4 Display Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `source-serif-4.005_Desktop/TTF/SourceSerif4Display-BoldIt.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `549fdb8f9a682bd06944298621404969f6de77c2e422ff3b8244a1dcd6a0c425` (17,634,695 bytes) |
| **sha256 of the SOURCE (upstream) file** | `d9ad45ac7ef86ae901ae1ca96733ef6d47717b335b94ea3594cc17c35cc3fc53` |
...
| item | value |
|---|---|
| **Shipped file** | `SourceSerif4Display-BoldIt.ttf` |
| **sha256 of the SHIPPED file** | `d9ad45ac7ef86ae901ae1ca96733ef6d47717b335b94ea3594cc17c35cc3fc53` |
| Size | 201,236 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Source Serif 4 Display` / `Bold Italic` |
