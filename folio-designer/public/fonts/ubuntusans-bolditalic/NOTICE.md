# UbuntuSans-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Ubuntu Sans**, added by
...
the family **`Ubuntu Sans Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `UbuntuSans-fonts-1.006/ttf/UbuntuSans-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `20aa7af47beaa6d64327782f7bf60df375edeedbdee2fe407e0bf9721890fb83` (29,602,887 bytes) |
| **sha256 of the SOURCE (upstream) file** | `eab551d7e3c178556e7e60c7a78cced8b7849b8edb1f873bbb9e1ce7aa08bf65` |
...
| item | value |
|---|---|
| **Shipped file** | `UbuntuSans-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `eab551d7e3c178556e7e60c7a78cced8b7849b8edb1f873bbb9e1ce7aa08bf65` |
| Size | 325,208 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Ubuntu Sans` / `Bold Italic` |
