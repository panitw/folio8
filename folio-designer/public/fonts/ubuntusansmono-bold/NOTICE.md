# UbuntuSansMono-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Ubuntu Sans Mono**, added by
...
the family **`Ubuntu Sans Mono Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `Ubuntu-Sans-Mono-fonts-v1.100/fonts/ttf/UbuntuSansMono-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `0e459ed18b552190971561b3e474d0c4583db40483debf9e951321c2a1c2dec8` (8,148,916 bytes) |
| **sha256 of the SOURCE (upstream) file** | `d490ee280816bafe6d9f21ce4f7519cc6e18e3fc0cfe24c770c5eede0950bd07` |
...
| item | value |
|---|---|
| **Shipped file** | `UbuntuSansMono-Bold.ttf` |
| **sha256 of the SHIPPED file** | `d490ee280816bafe6d9f21ce4f7519cc6e18e3fc0cfe24c770c5eede0950bd07` |
| Size | 217,332 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Ubuntu Sans Mono` / `Bold` |
