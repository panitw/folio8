# GeistMono-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Geist Mono**, added by
...
the family **`Geist Mono Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `geist-font/GeistMono/ttf/GeistMono-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `7fc800d2ac6b92844895196e5041aca55d814c15db70c44f79b3b83ab82b04e2` (8,207,303 bytes) |
| **sha256 of the SOURCE (upstream) file** | `27b5e991397af74bbb90c3137869967bed796b3792e269f1c294ef53bfbf8a33` |
...
| item | value |
|---|---|
| **Shipped file** | `GeistMono-Italic.ttf` |
| **sha256 of the SHIPPED file** | `27b5e991397af74bbb90c3137869967bed796b3792e269f1c294ef53bfbf8a33` |
| Size | 154,508 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Geist Mono` / `Italic` |
