# Geist-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Geist**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../geist/`, and **both come from
...
the family **`Geist Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `geist-font/Geist/ttf/Geist-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `7fc800d2ac6b92844895196e5041aca55d814c15db70c44f79b3b83ab82b04e2` (8,207,303 bytes) |
| **sha256 of the SOURCE (upstream) file** | `d0420f50612a7e8c2b697834555fbd5f92abc6f20b9ba6d96c0ffd5ab23b1a90` |
...
| item | value |
|---|---|
| **Shipped file** | `Geist-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `d0420f50612a7e8c2b697834555fbd5f92abc6f20b9ba6d96c0ffd5ab23b1a90` |
| Size | 130,600 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Geist` / `Bold Italic` |
...
family's Regular, copied from `../geist/LICENSE-OFL.txt`.
