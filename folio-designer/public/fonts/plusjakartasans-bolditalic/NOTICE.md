# PlusJakartaSans-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Plus Jakarta Sans**, added by
...
the family **`Plus Jakarta Sans Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `PlusJakartaSans-2.7.1/ttf/PlusJakartaSans-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `4bfc5cdf97d750423bb3d1d40ed8e529bc92288924d9c65e18ff486acefac66c` (1,018,646 bytes) |
| **sha256 of the SOURCE (upstream) file** | `3e65ec04a0ee974fcc43cab0e6fad6683dd47e205d995e7958e7c0b2a6137a84` |
...
| item | value |
|---|---|
| **Shipped file** | `PlusJakartaSans-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `3e65ec04a0ee974fcc43cab0e6fad6683dd47e205d995e7958e7c0b2a6137a84` |
| Size | 135,616 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Plus Jakarta Sans` / `Bold Italic` |
