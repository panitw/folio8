# Oswald-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Oswald**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../oswald/`, and **both come from
...
the family **`Oswald Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `OswaldFont-89795261ac9eeb9aa8cd99f43982c4e4b0e53261/fonts/ttf/Oswald-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `134464e4de9076860d7b9cd8781fa515cce1a9ed5a39089f4b7cb614d3aac9b5` (12,474,371 bytes) |
| **sha256 of the SOURCE (upstream) file** | `eb7d46f856dd57f18a8c03d033c57802692bf127f01dbd95ba8984338e6b5135` |
...
| item | value |
|---|---|
| **Shipped file** | `Oswald-Bold.ttf` |
| **sha256 of the SHIPPED file** | `eb7d46f856dd57f18a8c03d033c57802692bf127f01dbd95ba8984338e6b5135` |
| Size | 108,496 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Oswald` / `Bold` |
...
family's Regular, copied from `../oswald/LICENSE-OFL.txt`.
Its sha256 is `0687c51a3126ae6963389181135a2eaea02f2e88f31230d27409952f28e84da5` (4,390 bytes).
