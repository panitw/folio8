# Lora-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Lora**, added by
...
the family **`Lora Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/Lora-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `19061972d1124d258dffd41f3ad12ce2db513f9b31fb98ece7afe7b538e8647f` (2,443,935 bytes) |
| **sha256 of the SOURCE (upstream) file** | `1985f2fa49d675c3d88ca6a0b9161be38f955bec7efb025d2a5b68bc03e471fe` |
...
| item | value |
|---|---|
| **Shipped file** | `Lora-Italic.ttf` |
| **sha256 of the SHIPPED file** | `1985f2fa49d675c3d88ca6a0b9161be38f955bec7efb025d2a5b68bc03e471fe` |
| Size | 206,912 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Lora` / `Italic` |
