# Literata-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Literata**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../literata/`, and **both come from
...
the family **`Literata Bold Italic`** into `src/generated/runtime-fonts.css`.
...
`post.italicAngle` -2, **no** `fvar`/`gvar` and **no** `CFF`/`CFF2` —
...
| Path inside the archive | `fonts/ttf/Literata-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `f7fb973cafb26cf785cbebaeaf51c18f87c15a3bcf4d82a7d4857564db5b056d` (17,546,949 bytes) |
| **sha256 of the SOURCE (upstream) file** | `1dade59381ad02f4679d7e993a7a406472e587ac332af7a6168d3ad9214a99dc` |
...
| item | value |
|---|---|
| **Shipped file** | `Literata-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `1dade59381ad02f4679d7e993a7a406472e587ac332af7a6168d3ad9214a99dc` |
| Size | 318,888 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Literata` / `Bold Italic` |
...
family's Regular, copied from `../literata/LICENSE-OFL.txt`.
