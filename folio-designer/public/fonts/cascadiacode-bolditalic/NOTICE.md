# CascadiaCode-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Cascadia Code**, added by
...
the family **`Cascadia Code Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/static/CascadiaCode-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `e67a68ee3386db63f48b9054bd196ea752bc6a4ebb4df35adce6733da50c8474` (150,454,761 bytes) |
| **sha256 of the SOURCE (upstream) file** | `aff1984cbbdd990137691ae9567b87e7b1190f6a4e146017c6a0893ca4b000e7` |
...
| item | value |
|---|---|
| **Shipped file** | `CascadiaCode-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `aff1984cbbdd990137691ae9567b87e7b1190f6a4e146017c6a0893ca4b000e7` |
| Size | 458,632 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Cascadia Code` / `Bold Italic` |
