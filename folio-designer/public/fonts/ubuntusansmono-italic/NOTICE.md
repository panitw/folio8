# UbuntuSansMono-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Ubuntu Sans Mono**, added by
...
the family **`Ubuntu Sans Mono Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `Ubuntu-Sans-Mono-fonts-v1.100/fonts/ttf/UbuntuSansMono-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `0e459ed18b552190971561b3e474d0c4583db40483debf9e951321c2a1c2dec8` (8,148,916 bytes) |
| **sha256 of the SOURCE (upstream) file** | `43d110042d9c06732a123e1907a082ae14e7dc306fb95c47cddc478813f493fe` |
...
| item | value |
|---|---|
| **Shipped file** | `UbuntuSansMono-Italic.ttf` |
| **sha256 of the SHIPPED file** | `43d110042d9c06732a123e1907a082ae14e7dc306fb95c47cddc478813f493fe` |
| Size | 219,244 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Ubuntu Sans Mono` / `Italic` |
