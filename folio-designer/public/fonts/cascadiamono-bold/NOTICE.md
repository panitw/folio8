# CascadiaMono-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Cascadia Mono**, added by
...
the family **`Cascadia Mono Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/static/CascadiaMono-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `e67a68ee3386db63f48b9054bd196ea752bc6a4ebb4df35adce6733da50c8474` (150,454,761 bytes) |
| **sha256 of the SOURCE (upstream) file** | `b22cb603ed23cac36e8444846e1841caca21719a5e852780a8d37ae7a49b0a36` |
...
| item | value |
|---|---|
| **Shipped file** | `CascadiaMono-Bold.ttf` |
| **sha256 of the SHIPPED file** | `b22cb603ed23cac36e8444846e1841caca21719a5e852780a8d37ae7a49b0a36` |
| Size | 581,704 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Cascadia Mono` / `Bold` |
