# InterDisplay-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Inter Display**, added by
...
the family **`Inter Display Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `extras/ttf/InterDisplay-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `9883fdd4a49d4fb66bd8177ba6625ef9a64aa45899767dde3d36aa425756b11e` (33,707,794 bytes) |
| **sha256 of the SOURCE (upstream) file** | `b74c8e0dd744b3347faca4c96bc7b2e32f7d6f62300a79b1d1a99331e44a5bc4` |
...
| item | value |
|---|---|
| **Shipped file** | `InterDisplay-Bold.ttf` |
| **sha256 of the SHIPPED file** | `b74c8e0dd744b3347faca4c96bc7b2e32f7d6f62300a79b1d1a99331e44a5bc4` |
| Size | 418,856 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Inter Display` / `Bold` |
