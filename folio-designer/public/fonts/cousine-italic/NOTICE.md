# Cousine-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Cousine**, added by
...
the family **`Cousine Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `cousine-v1.241/fonts/ttf/Cousine-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `05e98396538fe59bddab7d631467a9a93b17f8461c7673d493c5b72dc37610e7` (1,712,494 bytes) |
| **sha256 of the SOURCE (upstream) file** | `ea2a76ae3d0ece9cd59f0d30fdc08dd70e8f5f457beee5b0852a7b50c2286c7c` |
...
| item | value |
|---|---|
| **Shipped file** | `Cousine-Italic.ttf` |
| **sha256 of the SHIPPED file** | `ea2a76ae3d0ece9cd59f0d30fdc08dd70e8f5f457beee5b0852a7b50c2286c7c` |
| Size | 306,880 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Cousine` / `Italic` |
