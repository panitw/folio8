# RobotoCondensed-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Roboto Condensed**, added by
...
the family **`Roboto Condensed Bold Italic`** into `src/generated/runtime-fonts.css`.
...
`OS/2.fsSelection` 0x0221, `head.macStyle` 0x3,
...
| Path inside the archive | `android/static/RobotoCondensed-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `1653dbe12f248da8fb0b9920db7b9496cd677ed3981154f6f15285c8bd4e334f` (29,162,959 bytes) |
| **sha256 of the SOURCE (upstream) file** | `d724911147c8de8335be204298cee96110ff60cedc45bdadc2ea28da625f22bf` |
...
| item | value |
|---|---|
| **Shipped file** | `RobotoCondensed-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `d724911147c8de8335be204298cee96110ff60cedc45bdadc2ea28da625f22bf` |
| Size | 376,928 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Roboto Condensed` / `Bold Italic` |
