# Inter-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Inter**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../inter/`, and **both come from
...
the family **`Inter Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `extras/ttf/Inter-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `9883fdd4a49d4fb66bd8177ba6625ef9a64aa45899767dde3d36aa425756b11e` (33,707,794 bytes) |
| **sha256 of the SOURCE (upstream) file** | `948405a16cdc62701da5f4005ed068ca5f4d27061d98f7974ccfc37831d9581d` |
...
| item | value |
|---|---|
| **Shipped file** | `Inter-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `948405a16cdc62701da5f4005ed068ca5f4d27061d98f7974ccfc37831d9581d` |
| Size | 425,296 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Inter` / `Bold Italic` |
...
family's Regular, copied from `../inter/LICENSE-OFL.txt`.
