# Cousine-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Cousine**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../cousine/`, and **both come from
...
the family **`Cousine Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `cousine-v1.241/fonts/ttf/Cousine-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `05e98396538fe59bddab7d631467a9a93b17f8461c7673d493c5b72dc37610e7` (1,712,494 bytes) |
| **sha256 of the SOURCE (upstream) file** | `848e858726fee0ae27b754e4cd6a2755209bf1428a8c91f747696d58c33906c3` |
...
| item | value |
|---|---|
| **Shipped file** | `Cousine-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `848e858726fee0ae27b754e4cd6a2755209bf1428a8c91f747696d58c33906c3` |
| Size | 308,292 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Cousine` / `Bold Italic` |
...
family's Regular, copied from `../cousine/LICENSE-OFL.txt`.
