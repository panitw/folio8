# SourceCodePro-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Source Code Pro**, added by
...
the family **`Source Code Pro Bold`** into `src/generated/runtime-fonts.css`.
...
`OS/2.fsSelection` 0x0020, `head.macStyle` 0x1,
...
| Path inside the archive | `TTF/SourceCodePro-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `0c85bac90d15c040b82939aa92bc8404420fccc02e37bbcb9c93a7f21abb52c6` (1,294,648 bytes) |
| **sha256 of the SOURCE (upstream) file** | `b2095e0d657e6d28dc32444a9dacabab0c9241d0bf39d96371756cc9bdbc3a5f` |
...
| item | value |
|---|---|
| **Shipped file** | `SourceCodePro-Bold.ttf` |
| **sha256 of the SHIPPED file** | `b2095e0d657e6d28dc32444a9dacabab0c9241d0bf39d96371756cc9bdbc3a5f` |
| Size | 206,804 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Source Code Pro` / `Bold` |
