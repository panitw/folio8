# CascadiaMono-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Cascadia Mono**, added by
...
the family **`Cascadia Mono Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/static/CascadiaMono-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `e67a68ee3386db63f48b9054bd196ea752bc6a4ebb4df35adce6733da50c8474` (150,454,761 bytes) |
| **sha256 of the SOURCE (upstream) file** | `8d98a33e7617c14dd1d200b4900bc6c2d5d7165abb5c09e9d2fd51c38ce9c9ff` |
...
| item | value |
|---|---|
| **Shipped file** | `CascadiaMono-Italic.ttf` |
| **sha256 of the SHIPPED file** | `8d98a33e7617c14dd1d200b4900bc6c2d5d7165abb5c09e9d2fd51c38ce9c9ff` |
| Size | 435,820 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Cascadia Mono` / `Italic` |
