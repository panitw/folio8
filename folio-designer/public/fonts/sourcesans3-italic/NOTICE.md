# SourceSans3-It.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Source Sans 3**, added by
...
the family **`Source Sans 3 Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `TTF/SourceSans3-It.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `1b0dd1ec44b39f1dd98bbd153a1a3815f083639874ddee02c842bd601bad3d21` (2,478,353 bytes) |
| **sha256 of the SOURCE (upstream) file** | `192afd78f0f54a3c69eaf02d43f4d9a821e9d6110e41d3d25d61a7385cd580e4` |
...
| item | value |
|---|---|
| **Shipped file** | `SourceSans3-It.ttf` |
| **sha256 of the SHIPPED file** | `192afd78f0f54a3c69eaf02d43f4d9a821e9d6110e41d3d25d61a7385cd580e4` |
| Size | 315,812 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Source Sans 3` / `Italic` |
