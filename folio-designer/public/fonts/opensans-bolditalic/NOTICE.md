# OpenSans-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Open Sans**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../opensans/`, and **both come from
...
the family **`Open Sans Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `opensans-bd7e37632246368c60fdcbd374dbf9bad11969b6/fonts/ttf/OpenSans-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `a1b16d859522daa826fb093d791ee252a1627274ef1b90f2773d670eb73a2a92` (30,976,885 bytes) |
| **sha256 of the SOURCE (upstream) file** | `d672a770037104b6af45e1336b3d3c1729c8aea940f81e010f5a8a7319c29a21` |
...
| item | value |
|---|---|
| **Shipped file** | `OpenSans-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `d672a770037104b6af45e1336b3d3c1729c8aea940f81e010f5a8a7319c29a21` |
| Size | 153,308 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Open Sans` / `Bold Italic` |
...
family's Regular, copied from `../opensans/LICENSE-OFL.txt`.
