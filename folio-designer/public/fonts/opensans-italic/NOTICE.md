# OpenSans-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Open Sans**, added by
...
the family **`Open Sans Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `opensans-bd7e37632246368c60fdcbd374dbf9bad11969b6/fonts/ttf/OpenSans-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `a1b16d859522daa826fb093d791ee252a1627274ef1b90f2773d670eb73a2a92` (30,976,885 bytes) |
| **sha256 of the SOURCE (upstream) file** | `93bc1bb6abf4e6b7c75d7131714061d5b57cc478abcabe4cb3519bb38fb917aa` |
...
| item | value |
|---|---|
| **Shipped file** | `OpenSans-Italic.ttf` |
| **sha256 of the SHIPPED file** | `93bc1bb6abf4e6b7c75d7131714061d5b57cc478abcabe4cb3519bb38fb917aa` |
| Size | 153,256 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Open Sans` / `Italic` |
