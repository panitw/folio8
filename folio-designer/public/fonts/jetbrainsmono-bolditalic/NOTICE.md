# JetBrainsMono-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **JetBrains Mono**, added by
...
the family **`JetBrains Mono Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `fonts/ttf/JetBrainsMono-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `6f6376c6ed2960ea8a963cd7387ec9d76e3f629125bc33d1fdcd7eb7012f7bbf` (5,622,857 bytes) |
| **sha256 of the SOURCE (upstream) file** | `4039d5ce0ed225bf9c8b2c8c6436290ae2f356b7e90d70fa666227238324aa3b` |
...
| item | value |
|---|---|
| **Shipped file** | `JetBrainsMono-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `4039d5ce0ed225bf9c8b2c8c6436290ae2f356b7e90d70fa666227238324aa3b` |
| Size | 279,832 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `JetBrains Mono` / `Bold Italic` |
