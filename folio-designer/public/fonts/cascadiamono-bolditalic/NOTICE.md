# CascadiaMono-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Cascadia Mono**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../cascadiamono/`, and **both come from
...
the family **`Cascadia Mono Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/static/CascadiaMono-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `e67a68ee3386db63f48b9054bd196ea752bc6a4ebb4df35adce6733da50c8474` (150,454,761 bytes) |
| **sha256 of the SOURCE (upstream) file** | `ecaeab55e6334408f8ff1fde78a99ddaeb3bb7fad4fcd177df8475c88a7d240f` |
...
| item | value |
|---|---|
| **Shipped file** | `CascadiaMono-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `ecaeab55e6334408f8ff1fde78a99ddaeb3bb7fad4fcd177df8475c88a7d240f` |
| Size | 439,072 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Cascadia Mono` / `Bold Italic` |
...
family's Regular, copied from `../cascadiamono/LICENSE-OFL.txt`.
