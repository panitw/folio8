# NotoSerif-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Noto Serif**, added by
...
the family **`Noto Serif Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `NotoSerif/unhinted/ttf/NotoSerif-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `0e9a43c8a4b94ac76f55069ed1d7385bbcaf6b99527a94deb5619e032b7e76c1` (70,637,713 bytes) |
| **sha256 of the SOURCE (upstream) file** | `24ad531e6b05ddad8c3d89572d2c93eb86a6b74e652ce7ee3c3e171de68e84c3` |
...
| item | value |
|---|---|
| **Shipped file** | `NotoSerif-Bold.ttf` |
| **sha256 of the SHIPPED file** | `24ad531e6b05ddad8c3d89572d2c93eb86a6b74e652ce7ee3c3e171de68e84c3` |
| Size | 481,892 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Noto Serif` / `Bold` |
