# SourceSerif4Display-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Source Serif 4 Display**, added by
...
the family **`Source Serif 4 Display Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `source-serif-4.005_Desktop/TTF/SourceSerif4Display-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `549fdb8f9a682bd06944298621404969f6de77c2e422ff3b8244a1dcd6a0c425` (17,634,695 bytes) |
| **sha256 of the SOURCE (upstream) file** | `c779701e5205f4200d862c492b39da1ef311ac0d71768ec741f8ef874add5ac9` |
...
| item | value |
|---|---|
| **Shipped file** | `SourceSerif4Display-Bold.ttf` |
| **sha256 of the SHIPPED file** | `c779701e5205f4200d862c492b39da1ef311ac0d71768ec741f8ef874add5ac9` |
| Size | 301,680 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Source Serif 4 Display` / `Bold` |
