# Literata-Italic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Literata**, added by
...
the family **`Literata Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `fonts/ttf/Literata-Italic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `f7fb973cafb26cf785cbebaeaf51c18f87c15a3bcf4d82a7d4857564db5b056d` (17,546,949 bytes) |
| **sha256 of the SOURCE (upstream) file** | `198f70cc9a17bab578553fa274b81984d58c440efe26bc06f1d841c194b6691a` |
...
| item | value |
|---|---|
| **Shipped file** | `Literata-Italic.ttf` |
| **sha256 of the SHIPPED file** | `198f70cc9a17bab578553fa274b81984d58c440efe26bc06f1d841c194b6691a` |
| Size | 304,104 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Literata` / `Italic` |
