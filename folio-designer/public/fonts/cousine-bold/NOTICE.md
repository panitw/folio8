# Cousine-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Cousine**, added by
...
the family **`Cousine Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `cousine-v1.241/fonts/ttf/Cousine-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `05e98396538fe59bddab7d631467a9a93b17f8461c7673d493c5b72dc37610e7` (1,712,494 bytes) |
| **sha256 of the SOURCE (upstream) file** | `17c8a7245156d2253531c9e529474937b09d9f641c5ae7695c5e33f22822eef4` |
...
| item | value |
|---|---|
| **Shipped file** | `Cousine-Bold.ttf` |
| **sha256 of the SHIPPED file** | `17c8a7245156d2253531c9e529474937b09d9f641c5ae7695c5e33f22822eef4` |
| Size | 298,048 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Cousine` / `Bold` |
