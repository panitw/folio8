# SpaceGrotesk-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Space Grotesk**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../spacegrotesk/`, and **both come from
...
the family **`Space Grotesk Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `SpaceGrotesk-2.0.0/ttf/static/SpaceGrotesk-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `53b415577d4139248555300710bea0d268c7a5be67b93de53b716a9736cabffd` (697,233 bytes) |
| **sha256 of the SOURCE (upstream) file** | `7209bbb75fc0f5c546a5f5773b0db74ffc6abf04c2148c1105cace5765a96bdb` |
...
| item | value |
|---|---|
| **Shipped file** | `SpaceGrotesk-Bold.ttf` |
| **sha256 of the SHIPPED file** | `7209bbb75fc0f5c546a5f5773b0db74ffc6abf04c2148c1105cace5765a96bdb` |
| Size | 116,056 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Space Grotesk` / `Bold` |
...
family's Regular, copied from `../spacegrotesk/LICENSE-OFL.txt`.
Its sha256 is `c6dec685825f73b18c20926fddc65e8315642e12986f15db0699170940a09efc` (4,402 bytes).
