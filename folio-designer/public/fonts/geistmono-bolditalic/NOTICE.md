# GeistMono-BoldItalic.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Geist Mono**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../geistmono/`, and **both come from
...
the family **`Geist Mono Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `geist-font/GeistMono/ttf/GeistMono-BoldItalic.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `7fc800d2ac6b92844895196e5041aca55d814c15db70c44f79b3b83ab82b04e2` (8,207,303 bytes) |
| **sha256 of the SOURCE (upstream) file** | `c063203f13080b71aa5416ec5f5a0e30bc0a0d9a8a33335479c676f5809b6d5d` |
...
| item | value |
|---|---|
| **Shipped file** | `GeistMono-BoldItalic.ttf` |
| **sha256 of the SHIPPED file** | `c063203f13080b71aa5416ec5f5a0e30bc0a0d9a8a33335479c676f5809b6d5d` |
| Size | 157,016 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Geist Mono` / `Bold Italic` |
...
family's Regular, copied from `../geistmono/LICENSE-OFL.txt`.
