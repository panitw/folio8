# SourceSans3-BoldIt.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold Italic** cut of the committed family **Source Sans 3**, added by
spec-install-all-face-cuts story 3 so that a family behaves the same whichever
tier it came from (CAP-3). Its Regular is `../sourcesans3/`, and **both come from
...
the family **`Source Sans 3 Bold Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `TTF/SourceSans3-BoldIt.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `1b0dd1ec44b39f1dd98bbd153a1a3815f083639874ddee02c842bd601bad3d21` (2,478,353 bytes) |
| **sha256 of the SOURCE (upstream) file** | `7978291fc1bf314db887e0366853b33c5cf2e964c7b95cfb9ce403a6ec46a842` |
...
| item | value |
|---|---|
| **Shipped file** | `SourceSans3-BoldIt.ttf` |
| **sha256 of the SHIPPED file** | `7978291fc1bf314db887e0366853b33c5cf2e964c7b95cfb9ce403a6ec46a842` |
| Size | 318,700 bytes |
| Instance | Bold Italic — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Source Sans 3` / `Bold Italic` |
...
family's Regular, copied from `../sourcesans3/LICENSE-OFL.md`.
Its sha256 is `db4728023c37bd1db542fd14ff9e4f3bcc23836b8374f6fe1f2351d38c2996d5` (4,486 bytes).
