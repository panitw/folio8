# Montserrat-Bold.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Bold** cut of the committed family **Montserrat**, added by
...
the family **`Montserrat Bold`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `Montserrat-9.000/fonts/ttf/Montserrat-Bold.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `991b3f971c65081c780fa15645a030bdf9e21ee8734b9f6010638b83bae1ff83` (30,979,460 bytes) |
| **sha256 of the SOURCE (upstream) file** | `c5ae3e40a9a3ae3a618d0a72772f306b502ce6c9a6ace312077aa50e09632c40` |
...
| item | value |
|---|---|
| **Shipped file** | `Montserrat-Bold.ttf` |
| **sha256 of the SHIPPED file** | `c5ae3e40a9a3ae3a618d0a72772f306b502ce6c9a6ace312077aa50e09632c40` |
| Size | 454,864 bytes |
| Instance | Bold — `OS/2.usWeightClass` 700, upstream static build |
| Declared family (`name` table) | `Montserrat` / `Bold` |
