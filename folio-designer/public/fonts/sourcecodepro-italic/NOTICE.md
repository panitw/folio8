# SourceCodePro-It.ttf — spec-install-all-face-cuts story 3, the committed tier's cuts
...
It is the **Italic** cut of the committed family **Source Code Pro**, added by
...
the family **`Source Code Pro Italic`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `TTF/SourceCodePro-It.ttf` |
| Fetched | 2026-09-20 |
| sha256 of the release archive | `0c85bac90d15c040b82939aa92bc8404420fccc02e37bbcb9c93a7f21abb52c6` (1,294,648 bytes) |
| **sha256 of the SOURCE (upstream) file** | `9c9e0f4d016210a3c5bdfba5262637c5b26ddff4ccc382ebbc781de5961d0042` |
...
| item | value |
|---|---|
| **Shipped file** | `SourceCodePro-It.ttf` |
| **sha256 of the SHIPPED file** | `9c9e0f4d016210a3c5bdfba5262637c5b26ddff4ccc382ebbc781de5961d0042` |
| Size | 166,548 bytes |
| Instance | Italic — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Source Code Pro` / `Italic` |
