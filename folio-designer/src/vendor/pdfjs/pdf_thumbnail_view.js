...
// FOLIO8 MODIFICATION 1 of 3 — `pdfjs-lib` is an alias that only exists inside
// pdf.js's own build. folio8 resolves the same two exports from the published
...
// FOLIO8 MODIFICATION 2 of 3 — the `AppOptions` import is deleted. It is read at
...
// FOLIO8 MODIFICATION 3 of 3 (declaration) — app_options.js's own values for
...
class PDFThumbnailView extends RenderableView {
  ...
  constructor({
    ...
    // FOLIO8 MODIFICATION 3 of 3 — the two `AppOptions.get(...)` fallbacks are
