...
// folio8-go. The designer surface lives unexported in this package and in
...
func TestDesignerSurfaceIsUnreachableFromOutsideTheModule(t *testing.T) {
	...
	t.Run("control: the kept API builds", func(t *testing.T) {
		out, err := build(t, `import folio8 "github.com/panitw/folio8/folio8-go"
...
func main() {
	...
	for _, probe := range []struct{ name, source, cause string }{
		{"folio8.Canvas", `import folio8 "github.com/panitw/folio8/folio8-go"

func main() { _ = folio8.Canvas }`, "undefined: folio8.Canvas"},
		{"folio8.ApplyComponentCommand", `import folio8 "github.com/panitw/folio8/folio8-go"

func main() { _ = folio8.ApplyComponentCommand }`, "undefined: folio8.ApplyComponentCommand"},
		{"folio8.CanvasProjection", `import folio8 "github.com/panitw/folio8/folio8-go"

func main() { var _ folio8.CanvasProjection }`, "undefined: folio8.CanvasProjection"},
		{"folio8-go/wasm", `import _ "github.com/panitw/folio8/folio8-go/wasm"

func main() {}`, "does not contain package github.com/panitw/folio8/folio8-go/wasm"},
		{"internal/wasm", `import _ "github.com/panitw/folio8/folio8-go/internal/wasm"

func main() {}`, "use of internal package github.com/panitw/folio8/folio8-go/internal/wasm not allowed"},
		{"internal/designer", `import _ "github.com/panitw/folio8/folio8-go/internal/designer"

func main() {}`, "use of internal package github.com/panitw/folio8/folio8-go/internal/designer not allowed"},
	} {
